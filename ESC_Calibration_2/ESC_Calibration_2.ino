...
void setup() {
    ...
    motA.attach(A0, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH);
    motB.attach(A1, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH);
    motC.attach(A2, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH);
    motD.attach(A3, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH);
